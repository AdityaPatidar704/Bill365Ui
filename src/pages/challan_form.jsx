  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      const addChallanData=async ()=>{
        try{
          const token=localStorage.getItem("token");
          const res=await axios.post(`http://localhost:5003/api/challan/submit`,values,{
            headers:{
              Authorization: `Bearer ${token}`,
            }
          })
      ...
      <div className="py-6">
        <div className="w-full max-w-4xl p-8 bg-white rounded-lg shadow-md ">
           ...
           */}
           ...
           <ButtonComponent type="button" className="btn btn-primary float-end" value="close" label="Close"></ButtonComponent>
           </NavLink>
          <form className="" onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-6 overflow-x-auto">
              ...
              <ButtonComponent type="button" value="button" label="Add Product" onClick={handleAddProductRow} className="p-3 mt-4 text-white bg-blue-700 rounded-md hover:bg-blue-800"></ButtonComponent>
            </div>
            ...
            <div className="flex justify-end">
              ...
              <ButtonComponent type="submit" value="submit" label="Generate Challan" className="px-6 py-3 text-white bg-green-600 rounded-md hover:bg-green-700">
              <NavLink to="/challan"></NavLink>
              </ButtonComponent>
            </div>
          </form>
        </div>
